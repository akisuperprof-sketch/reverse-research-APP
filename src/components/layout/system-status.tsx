...
import { Activity, Flame, Trophy, Terminal, Radar, Cpu } from "lucide-react";
...
export function SystemStatusSidebar({ result }: SystemStatusSidebarProps) {
  ...
  return (
    <div className="w-[320px] flex-shrink-0 border-l border-slate-800 bg-[#0B1120] flex flex-col h-full overflow-hidden text-slate-300">
